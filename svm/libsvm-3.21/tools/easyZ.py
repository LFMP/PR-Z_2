...
if not is_win32:
	...
	grid_py = dirPath + "tools/grid.py"
	gnuplot_exe = "/usr/local/bin/gnuplot"
else:
        # example for windows
	svmscale_exe = r"Z:\\Teste3\\Easy\\libsvm-3.21\\windows\\svm-scale.exe"
	svmtrain_exe = r"Z:\\Teste3\\Easy\\libsvm-3.21\\windows\\svm-train.exe"
	svmpredict_exe = r"Z:\\Teste3\\Easy\\libsvm-3.21\\windows\\svm-predict.exe"
	gnuplot_exe = r"Z:\\Teste3\\Easy\\gnuplot\\bin\\pgnuplot.exe"
	grid_py = r"Z:\\Teste3\\Easy\\libsvm-3.21\\tools\\grid.py"
...
#cmd = "python %s -svmtrain %s %s" % (grid_py, svmtrain_exe, scaled_file)
